...
public class ExecutionStatusInfo {
    ...
    public static final String QUEUED_PTPUBLISH = "QUEUED_PTPUBLISH";

    public static final String PTPUBLISH_ACCEPTED = "PTPUBLISH_ACCEPTED";

    public static final String PTPUBLISH_INPROGRESS = "PTPUBLISH_INPROGRESS";
